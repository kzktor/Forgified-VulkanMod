...
public class CustomVertexFormat {
    ...
    public static final VertexFormatElement ELEMENT_EXTERNAL_LOD_POSITION = new VertexFormatElement(0, VertexFormatElement.Type.USHORT, VertexFormatElement.Usage.POSITION, 4);
    public static final VertexFormatElement ELEMENT_EXTERNAL_LOD_PADDING = new VertexFormatElement(0, VertexFormatElement.Type.BYTE, VertexFormatElement.Usage.NORMAL, 4);
    ...
    public static final VertexFormat EXTERNAL_LOD = new VertexFormat(new ImmutableMap.Builder<String, VertexFormatElement>()
        .put("Position", ELEMENT_EXTERNAL_LOD_POSITION).put("Color", ELEMENT_COLOR).put("Padding", ELEMENT_EXTERNAL_LOD_PADDING).build());
